...
SES_SENDER_EMAIL = os.environ.get('SES_SENDER_EMAIL', 'imindrajitdan@gmail.com')
SES_RECIPIENT_EMAIL = os.environ.get('SES_RECIPIENT_EMAIL', 'imindrajitdan@gmail.com')
